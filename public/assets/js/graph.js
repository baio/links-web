...
(function() {
  ...
  $(function() {
    d3.xml("/data/main.gexf", "application/xml", function(gexf) {
      var edges, force, grp_edges, nodes;
      console.log(gexf);
      ...
      force = d3.layout.force().charge(-120).linkDistance(30).size([500, 300]);
      return force.nodes(nodes).links(grp_edges).start();
    });
    /*
